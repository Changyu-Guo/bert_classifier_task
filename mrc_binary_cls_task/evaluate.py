...
INFERENCE_RESULT_PATH = 'infer_results/version_2/postprocessed/valid_results.json'
# INFERENCE_RESULT_PATH = '../naive_mrc_task/inference_results/last_task/use_version_2/' \
